                                    ...
                                    <div class="form-row" v-show="attendee.attendee_type == 1">
                                        <div class="form-group col-12">
                                            ...
                                            <select class="form-control selectpicker" v-model="attendee.attendee_id">
                                                <option value="0" selected disabled>Select Applicant</option>
                                                <option class="optionpicker" v-for="(applicant, key) in applicant" :key="key" :value="applicant.id" >
...
export default {
    ...
    data: function () {
        return {
            routePrefix: "/api/events/induction/attendee/",
            datatable: {
                data: {},
                current_page: 1,
                per_page: 15,
    ...
    methods: {
        ...
        getApplicant() {
        axios
            .get(this.routePrefix + "applicant").then((response) => {
                this.applicant = response.data;
            });
        },
        getStaff() {
        axios
            .get(this.routePrefix + "staff").then((response) => {
