            ...
            <div class="col-xs-6 col-sm-6 col-md my-auto">
                <div class="mt-2 mb-0">
                    <div class="h3" v-if="event.type == 1">
                        <span style="margin-bottom: 1.375rem;">Induction - </span><span class="text-muted" style="text-transform: capitalize;">{{ event.location }}</span>
                    </div>
                    <div class="h3" v-else>
                        <span style="margin-bottom: 1.375rem;">Training - </span><span class="text-muted" style="text-transform: capitalize;">{{ event.location }}</span>
                    </div>
                </div>
            </div>
        </div>
