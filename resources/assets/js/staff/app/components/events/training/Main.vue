                    ...
                    <tbody class="bg-white">
                      <tr v-for="(event, key) in datatable.data" v-bind:key="key">
                        ...
                        <td class="text-center">
                          ...
                          <div class="btn btn-danger btn-sty btn-sm">
                            <i class="fas fa-times mr-1"></i> Expired
                          </div>
                        </td>
                        <td class="text-center">
                          <div class="btn-group">
                            <router-link class="btn btn-outline-secondary btn-sm" :to="'/training/booking/' + event.id">
...
export default {
  ...
  data: function () {
    return {
      routePrefix: "/api/events/training/booking/",
      sort: "all",
      search: "",
      filterBranch: null,
      datatable: {
  ...
  methods: {
    ...
    create() {
      axios
        ...
        .then((response) => {
          this.$router.push("/training/booking/" + response.data.id);
        })
        .catch((error) => {
