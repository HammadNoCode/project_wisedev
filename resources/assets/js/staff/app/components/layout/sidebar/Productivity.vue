<template>
	<div>
		<li class="nav-main-item">
			<router-link class="nav-main-link" active-class="active" :to="{ name: 'Tasks' }">
				<i class="nav-main-link-icon fas fa-tasks"></i>
				<span class="nav-main-link-name">Tasks</span>
			</router-link>
		</li>
		<!-- <li class="nav-main-item">
			<router-link class="nav-main-link" active-class="active" :to="{ name: 'Calls' }">
				<i class="nav-main-link-icon fas fa-phone"></i>
				<span class="nav-main-link-name">Calls</span>
			</router-link>
		</li> -->
	</div>
</template>
